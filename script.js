...
btn.addEventListener("click", (e) => {
    ...
    // let b = ["Banana", "Apple", "Watermelon", "Grapes", "Avocado", "Pineapple", "Strawberry", "Cherry", "Kiwi", "Orange"][a]
    // console.log(a)
...
A first-aid kit.`,
    ...
    let jee = (document.getElementById("place").innerHTML = emo);
    document.getElementById("place").innerHTML = bb + "<br>" + jee;
...
let dkModeBtn = document.getElementById('dkMode')
let title = document.querySelector('h1')
let output = document.getElementById('place')
let faMoon = document.getElementsByClassName('fa-moon')[0]
console.log(title, output, faMoon)

dkModeBtn.addEventListener('click', (e) => {
    console.log(2)
    ...
    title.style.color != 'white' ? title.style.color = 'white' : title.style.color = 'black'
    output.style.color != 'white' ? output.style.color = 'white' : output.style.color = 'black'
